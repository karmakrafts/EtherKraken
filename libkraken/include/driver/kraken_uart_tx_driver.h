...
#ifndef LIBKRAKEN_KRAKEN_UART_TX_DRIVER_H
#define LIBKRAKEN_KRAKEN_UART_TX_DRIVER_H

#include "kraken_error.h"
#include "kraken_uart.h"
...
KRAKEN_EXPORT kraken_error_t kraken_uart_tx_driver_write(kraken_driver_handle_t handle, const void* data, size_t size);
...
#endif//LIBKRAKEN_KRAKEN_UART_TX_DRIVER_H